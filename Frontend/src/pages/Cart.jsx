      ...
      <div className='mt-8'>
        {cartData.length === 0 || !products || products.length === 0 ? (
          ...
          cartData.map((item) => {
            ...
            if (!productData) {
              return (
                <div key={`${item._id}-${item.size}`} className='py-4 border-b text-xs text-gray-400 italic'>
            ...
            return (
              <div 
                key={`${item._id}-${item.size}`} // Uses unique id + size combination instead of array index
              ...
              >
                ...
                <div>
                  <input 
                    ...
                    type="number" 
                    min={1} 
                    value={item.quantity} // Controlled assignment
                  />
                </div>
